<template>
    ...
    <form class="inputs" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label for="prod_category">Danh mục</label>
        ...
        <div class="form-group">
            <label for="prod_desc">Mô tả</label>
        ...
        <div class="form-group">
            <button class="btn btn-primary mr-4" type="submit" @click="createProduct(this.FormProduct)">Thêm</button>
            <!-- Modal footer -->
            <!-- <div class=""> -->
